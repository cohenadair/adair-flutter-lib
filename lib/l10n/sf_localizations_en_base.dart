...
/// Syncfusion's own default English resource values (from
/// syncfusion_flutter_core's private `_DefaultLocalizations`), copied here
/// only because [SfLocalizations] must be implemented in full. Subclasses
/// need only override [noEventsCalendarLabel] with an app-specific message.
abstract class SfLocalizationsEnBase implements SfLocalizations {
  const SfLocalizationsEnBase();
